...
public class Event { private String title, description, category; private LocalDateTime dateTime; private double price; private List<String> attendees = new ArrayList<>(); private int capacity;
...
public void inputPrice(Scanner scanner) {
    while (true) {
        ...
        if (scanner.hasNextDouble()) {
            ...
            System.out.println("Invalid price."); scanner.nextLine();
        }
    }
}
...
public boolean removeAttendee(String name) {
    if (attendees.remove(name)) {
        System.out.println(name + " has been removed."); return true;
    }
    System.out.println(name + " not found."); return false;
}
